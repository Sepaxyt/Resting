...
bot = telebot.TeleBot('7392960015:AAGsqldQ0QKWlmTmdnhVpS6h9E32sOX9QR8')


admin_ids = {"6515915109", "6515915109", "6515915109"}
        ...
        try:
            ...
            if chat_member.status == 'member':
                ...
                if len(command) == 4:
                    ...
                    if time > 200:
                        response = "Error: Time interval must be less than or equal to 200."
                    else:
                ...
                response = f"You need to join our channel to use this command. Join here: {https://t.me/+PTSVZh2ve5FmZTF}"
...
Official Channel: https://t.me/+PTSVZh2ve5FmZTF
'''
...
✅ Join: https://t.me/+PTSVZh2ve5FmZTF'
    send_response(message, response)
...
def join_channel(message):
    bot.send_message(message.chat.id, f"Join our channel to use the /bgmi command: {https://t.me/+PTSVZh2ve5FmZTF}")
